...
crawl-sample: ## Run a sample crawl for Lidl and Konzum
	docker compose -f docker-compose.yml -f docker-compose.local.yml run --rm crawler python crawler/cli/crawl.py /app/output --chain lidl,konzum

crawl-all: ## Crawl all data
	docker compose -f docker-compose.yml -f docker-compose.local.yml run --rm crawler python crawler/cli/crawl.py /app/output
